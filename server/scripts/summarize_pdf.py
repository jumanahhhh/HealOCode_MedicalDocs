...
def main():
    ...
    while True:
        pdf_path = input("Please enter the full path to your medical PDF file: ").strip()
        ...
        if not medical_text:
            print("Failed to extract text from the PDF. Please try another file.")
            continue
...
def extract_text_from_pdf(pdf_path):
    try:
        ...
        return text[:1000]  # Limit output if needed
    except Exception as e:
